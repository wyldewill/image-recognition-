...
ap.add_argument("-m", "--model", default="mobilenet_ssd_v2/mobilenet_ssd_v2_coco_quant_postprocess_edgetpu.tflite",
...
cv2.createTrackbar("Size", 'Controls', int(args['width']), 2000, updateSize)
...
def drawFrame():
    ...
    cv2.putText(orig, f"{int(thresh * 100)}% Threshold", (args["width"] - 130, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                (0, 255 * thresh, 255 * (1 - thresh)), 2)
